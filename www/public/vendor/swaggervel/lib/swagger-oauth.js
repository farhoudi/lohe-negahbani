...
function initOAuth(opts) {
  ...
  username = (o.username||errors.push('missing username'));
  password = (o.password||errors.push('missing password'));
  clientId = (o.clientId||errors.push('missing client id'));
  clientSecret = (o.clientSecret||errors.push('missing client secret'));
  grantType = (o.grantType||errors.push('missing grant type'));
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState == XMLHttpRequest.DONE) {
      ...
      try {
        ...
        document.getElementById('input_apiKey').value = response.token_type + " " + response.access_token;
