!function () {
    ...
    var t = {
        ...
        steps: [{
            title: "لوح نگهبانی چیست؟",
            content: "لوح نگهبانی، شامل مجموعه‌ای از کانال‌های آموزشی می‌باشد که اقدام به ارائه آموزش‌های مختلف می‌نمایند.",
            target: "header-brand",
            placement: "left"
        }, {
            ...
            content: "شما برای استفاده از آموزش‌های لوح نگهبانی باید عضو سیستم باشید، استفاده از آویسا بسیار آسان است.",
            target: "avisa-steps",
            placement: "left"
        }],
