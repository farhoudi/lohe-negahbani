    ...
    */
    ...
    'custom'               => [
        'g-recaptcha-response' => [
            ...
            'recaptcha' => 'کد تایید اشتباه است!',
        ],
        'old_password' => [
            'hash' => 'کلمه عبور فعلی اشتباه است.',
        ],
        'national_code' => [
            'national_code' => 'فرمت کد ملی اشتباه است.',
        ],
        'user_group.*.id' => [
            'required' => 'یکی (یا بیشتر) از گروه های کاربری معتبر نیست.',
            'numeric' => 'یکی (یا بیشتر) از گروه های کاربری معتبر نیست.',
        ],
        'user_group.*.amount' => [
            'required' => 'تمامی مقادیر اعتبار ضروری هستند.',
            'numeric' => 'یکی (یا بیشتر) از مقادیر اعتبار معتبر نیست.',
        ],
        'user.*.id' => [
            'required' => 'یکی (یا بیشتر) از کاربرها معتبر نیست.',
            'numeric' => 'یکی (یا بیشتر) از کاربرها معتبر نیست.',
        ],
        'user.*.amount' => [
            'required' => 'تمامی مقادیر اعتبار ضروری هستند.',
            'numeric' => 'یکی (یا بیشتر) از مقادیر اعتبار معتبر نیست.',
