...
NovinDatePicker.setDiff = function () {
    if (NovinDatePicker.currentInput.value !== '') {
        try {
            /*var jDate = NovinDatePicker.currentInput.value;
            console.log(jDate);
            jDate = jDate.split('-');
            console.log(jDate);
            if (jDate.length !== 3) {
            ...
            var gNow = new Date(),
                gDate = NovinDatePicker.toGregorian(jy, jm, jd);
            console.log(gDate);
            ...
            var diffDays = Math.round((gDate.getTime() - gNow.getTime()) / oneDay);

            console.log(diffDays);

            NovinDatePicker.currentInput.setAttribute('diff', diffDays);*/
            ...
            var jy = parseInt(jDate[0]),
                jm = parseInt(jDate[1]);
            var jNow = NovinDatePicker.nowJ;
            var monthDiff = jm - jNow.jm + (12 * (jy - jNow.jy));
            NovinDatePicker.currentInput.setAttribute('diff', monthDiff);
